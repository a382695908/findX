...
if [ $# -eq 1 ];then
    if [ $1 = "o" ] || [ $1 = "official" ];then
        ...
        cp ~/workspace/egret/egret-3d/Sample-wing/egret3d.d.ts ./src
        ...
        cp ~/workspace/git/github/egret-3d/Sample-wing/egret3d.js ./
        cp ~/workspace/git/github/egret-3d/Sample-wing/egret3d.js ./src
        cp ~/workspace/git/github/egret-3d/Sample-wing/egret3d.d.ts ./src
    else
        echo -e "\n$0 [ o | 1 | m ]\n"
		exit 0
    fi
